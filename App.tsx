...
const App: React.FC = () => {
  ...
  const tier1Sponsors =
    result?.sponsors.filter(s => s.tier.toString().includes('1')) || [];

  const tier2Sponsors =
    result?.sponsors.filter(s => s.tier.toString().includes('2')) || [];
              ...
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  {[1, 2, 3, 4].map(i => (
                    <div
                      key={i}
                      className="bg-white rounded-xl h-48 border border-slate-200 animate-pulse p-6"
                    >
            ...
            {result && !loading && (
              <div className="space-y-10">
                ...
                <section>
                  <div className="flex items-center justify-between mb-4 border-b border-slate-200 pb-2">
                    <h3 className="text-lg font-bold text-slate-800 flex items-center gap-2">
                      <span className="w-6 h-6 bg-blue-600 rounded-md flex items-center justify-center text-white text-[10px]">
                        1
                      </span>
                ...
                <section>
                  <div className="flex items-center justify-between mb-4 border-b border-slate-200 pb-2">
                    <h3 className="text-lg font-bold text-slate-800 flex items-center gap-2">
                      <span className="w-6 h-6 bg-slate-400 rounded-md flex items-center justify-center text-white text-[10px]">
                        2
                      </span>
